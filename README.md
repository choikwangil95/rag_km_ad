...
<img width="1206" alt="스크린샷 2024-12-01 오후 2 21 47" src="https://github.com/user-attachments/assets/dc191d04-6a4a-4b10-b8a3-f007928e911d">
...
### 문제정의
- **문제**: 약 100개의 카카오모빌리티 광고상품 정보 확인이 힘들다.
- **해결**: 카카오모빌리티 광고상품 정보제공 및 추천하는 챗봇을 제공한다.

### 주요 기능

- **광고상품 설명 및 추천**: 카카오모빌리티 광고상품 데이터 대한 정보 제공 및 추천
- **웹 검색**: 카카오모빌리티 광고상품 데이터 외 질문 시 웹 검색 후 답변제공
- **리포트 분석**: CSV 리포트 파일 업로드 시 리포트 분석

### 서비스 플로우
- 1 사용자 입력에 따라 Superviser Agent가 적절한 도구를 선택
- 2 선택한 도구의 결과와 유저 질문을 프롬프트에 입력
- 3 LLM으로 답변 생성 및 제공
